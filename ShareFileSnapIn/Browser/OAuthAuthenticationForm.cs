...
namespace ShareFile.Api.Powershell.Browser
{
    public partial class OAuthAuthenticationForm : Form
    {
        ...
        private void CoreWebView2_ProcessFailed(object sender, CoreWebView2ProcessFailedEventArgs e)
        {
            ...
            // TODO: Better handling/logging of WebView2 process failures
        }

        private void LogProcessFailedEventArgs(CoreWebView2ProcessFailedEventArgs e)
        {
            Console.Error.WriteLine($"WebView2 process failed: Reason: {e.Reason} Exit code: {e.ExitCode} ProcessFailedKind: {e.ProcessFailedKind} Process description: {e.ProcessDescription}");
